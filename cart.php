    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                $sId = session_id();
                $queryCartCheck = mysqli_query($conn, "SELECT COUNT(*) as total FROM `tbl_giohang` WHERE `sessionID` = '$sId' AND `soLuongSanPham` > 0");
                $rowCartCheck = mysqli_fetch_assoc($queryCartCheck);

                if ($rowCartCheck['total'] == 0) {
                ...
                <?php
                    ...
                    // Nếu giỏ hàng không trống, tiếp tục hiển thị bảng
                ?>
                                        ...
                                        <td class="cart-unit">
                                            <ul class="price text-right">
                                                <li class="price special-price">
                                                    <?php echo number_format($rows['giaSanPham']); ?>
                                                    VNĐ</li>
                            ...
                            <tfoot>
                                ...
                                <tr class="cart-total-price">
                                    ...
                                    <td id="total_product" class="price" colspan="1">
                                        <?php echo number_format($sup_total); ?>
                                        VNĐ</td>
                                </tr>
                ...
                <?php
                } // Kết thúc điều kiện kiểm tra giỏ hàng trống
                ?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
